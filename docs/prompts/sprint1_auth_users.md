...
2) src/core/users/models/user.model.ts
   - email único, name, passwordHash, workspaceIds[], companyIds[], createdAt/updatedAt.
...
9) src/core/workspaces/*
   - Workspace { name, members: [{userId, role}] }, endpoints: invitar/cambiar rol.
10) src/core/devices/*
